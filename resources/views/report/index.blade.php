            ...
            <form method="post" action="{{route('report.store')}}">
                ...
                <div id="reports" class="col-md-12">
                    ...
                    <div class="card card-secondary shadow mb-4 p-0">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <select class="duallistbox" multiple="multiple" name='properties[]'>
                                    <option value='property_phase'>Property Phase</option>
                                    <option value='city'>City</option>
                                    <option value='area'>Area</option>
                                    <option value='house_street'>House No./ Street</option>
                                    <option value='postcode'>Postcode</option>
                                    <option value='no_bric_beds'>No. Bric Beds</option>
                                    <option value='no_bric_bathrooms'>No. Bric Bathrooms</option>
