...
<div class="modal fade" id="PostcodeModal" tabindex="-1" role="dialog" aria-labelledby="PostcodeModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="postcode_add_modal" type="text" class="form-control @error('postcode') is-invalid @enderror" name="postcode" value="{{ old('postcode') }}" autocomplete="postcode" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="area_add_modal" type="text" class="form-control @error('area') is-invalid @enderror" name="area" value="{{ old('area') }}" autocomplete="area" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="city_add_modal" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" autocomplete="city" required>
