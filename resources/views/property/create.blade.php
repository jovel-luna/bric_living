...
@section('content')
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs" id="propertyTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="new-property-info-tab" data-toggle="tab"
                                            href="#new-property-info" role="tab" aria-controls="new-property-info"
                                            aria-selected="true">Property Info</a>
                                    </li>
                                    <li class="nav-item not-allowed">
                                        <a class="nav-link disabled" id="acquisition-tab" data-toggle="tab"
                                ...
                                <div class="tab-content mt-4">
                                    <!-- New Property -->
                                    <div class="tab-pane active" id="new-property-info" role="tabpanel"
                                        aria-labelledby="new-property-info-tab">
    ...
    <!-- Modal -->
    <div class="modal fade" id="lettingStatusModal" tabindex="-1" role="dialog"
        aria-labelledby="lettingStatusModalTitle" aria-hidden="true">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <div class="row">
                                        <!-- Letting Status -->
                                        <div class="mb-3">
                                            <label for="letting_status_name"
                                                class="col-form-label">{{ __('Letting Status Name') }}<span
                                                    class="isRequired"> * </span></label>
                                            <input id="letting_status_name" type="text"
                                                class="form-control @error('letting_status_name') is-invalid @enderror"
                                                name="letting_status_name" value="{{ old('letting_status_name') }}"
                                                autocomplete="letting_status_name" required>
    ...
    <div class="modal fade" id="PostcodeModal" tabindex="-1" role="dialog" aria-labelledby="PostcodeModalTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="PostcodeModalTitle">Add New</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form method="POST" id="PostcodeModalForm" action="{{ route('location.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                            <label for="postcode" class="col-form-label">{{ __('Postcode') }}<span
                                                    class="isRequired"> * </span></label>
                                            <input id="postcode_add_modal" type="text"
                                        ...
                                        <div class="mb-3">
                                            <label for="area" class="col-form-label">{{ __('Area') }}<span
                                                    class="isRequired"> * </span></label>
                                            <input id="area_add_modal" type="text"
                                                class="form-control @error('area') is-invalid @enderror" name="area"
                                                value="{{ old('area') }}" autocomplete="area" required>
                                        ...
                                        <div class="mb-3">
                                            <label for="city" class="col-form-label">{{ __('City') }}<span
                                                    class="isRequired"> * </span></label>
                                            <input id="city_add_modal" type="text"
            ...
            $(document).ready(function() {
                ...
                $(document).on('change', '.add-file-btn', function(evt) {
                    ...
                    if (evt.target.files.length != 0) {
                        for (var i = 0; i < evt.target.files.length; i++) {
                            ...
                            if (documentArray.length != 0) {
                                ...
                                if (hasExisting === false) {
                                    ...
                                    output += '<li id="' + sectionIdentifier + '_' + getCounter +
                                        '" class="document-item">' +
                                        '<span class="document-title">' + escape(file.name) + '</span>' +
                                        '<img id="image-preview">' +
                                        '<span class="actions"><i id="trash-btn" class="fa-solid fa-trash-can removeFile" data-fileid="' +
                                        fileId + '"></i>' +
                                        '</span>' +
                                        '</li>';
                                    childObj.parent().parent().parent().find(".document-list").append(output);
                                    if (isImage) {
                                        childObj.parent().parent().parent().find(".document-list").find('#' +
                                                sectionIdentifier + '_' + getCounter).find('.document-title')
                                            .remove();
                                        var reader = new FileReader();
                                        reader.onload = function(e) {
                                            childObj.parent().parent().parent().find(".document-list").find(
                                                '#' + sectionIdentifier + '_' + getCounter).find(
                                        ...
                                        childObj.parent().parent().parent().find(".document-list").find('#' +
                                                sectionIdentifier + '_' + getCounter).find('#image-preview')
                                            .remove();
                                    }
                                }
                            } else {
                        ...
                        childObj.parent().parent().parent().parent().find('label.document-status-icon i')
                            .remove();
                        childObj.parent().parent().parent().parent().find('label.document-status-icon').append(
                            '<i class="fa-solid fa-circle-check has-file-checked">');
                    }
                        ...
                        case 'acquisition_status':
                            if (e.target.value != "") {
                                ...
                                if (e.target.value === 'Completed') {
                                    ...
                                    $('#completion_date').parent().find('label').append(
                ...
                $(document).on('change',
                    '#property_phase, #entity, #house_no, #street, #postcode, #acquisition_status, #asking_price, #existing_beds, #agent, #tennure, #portfolio, #existing_bedroom_no, #estimated_period, #status, #insurance_value, #insurance_in_cost, #capex_budget',
                    function(e) {
                        if (e.target.value != "") {
                            $(this).removeClass("is-invalid");
                        } else {
                ...
                $(document).on('blur',
                    '#asking_price, #agreed_purchase_price, #agent_fee_percentage, #bridge_loan, #estimated_period, #loan_percentage, #bric_y1_proposed_rent_pppw, #tenancy_length_weeks, #no_of_bric_beds, #estimated_tpc, #existing_bedroom_no, #capex_budget',
                    function(e) {
                        switch (e.target.name) {
                ...
                function validateFields(id, proceed) {
                    switch (id) {
                        ...
                        case 'acquisition':
                            ...
                            if (acquisition_status === "Completed" && $("#completion_date").datepicker('getDate') !=
                                null) {
                                if ($('#insurance_in_place').is(':checked') && insurance_value != "" &&
                                    insurance_in_cost != "" && insurance_renewal_date != "") {
                                    hasInsurance = true;
                                } else {
                                    hasInsurance = false;
                                }
                            ...
                            if (acquisition_status != "" && single_asset_portfolio != "" && existing_bedroom_no != "" &&
                                asking_price != "" && agent != "" && estimated_period != "" && tennure != "" && capex !=
                                "" && hasInsurance == true && cdIsRequired == false) {
                                if ($('#capex_budget').val()) {
                                ...
                                if (acquisition_status == "") {
                                    $('#acquisition_status').addClass("is-invalid")
                                }
                                if (single_asset_portfolio == "") {
                                    $('#single_asset_portfolio').addClass("is-invalid")
                                }
                                if (existing_bedroom_no == "") {
                                    $('#existing_bedroom_no').addClass("is-invalid")
                                }
                                if (asking_price == "") {
                                    $('#asking_price').addClass("is-invalid")
                                }
                                if (agent == "") {
                                    $('#agent').addClass("is-invalid")
                                }
                                if (estimated_period == "") {
                                    $('#estimated_period').addClass("is-invalid")
                                }
                                if (tennure == "") {
                                    $('#tennure').addClass("is-invalid")
                                }
                                if (capex == "") {
                                    $('#capex_budget').addClass("is-invalid")
                                }
                                if ($("#completion_date").datepicker('getDate') != null) {
                                    if (insurance_value == "") {
                                        $('#insurance_value').addClass("is-invalid")
                                    }
                                    if (insurance_in_cost == "") {
                                        $('#insurance_in_cost').addClass("is-invalid")
                                    }
                                    if (insurance_renewal_date == null) {
                                        $('#insurance_renewal_date').addClass("is-invalid")
                                    }
                                }
                        ...
                        case 'development':
                            ...
                            if (existing_beds != "" && bric_y1 != "") {
                                ...
                                if (existing_beds == "") {
                                    $('#existing_beds').addClass("is-invalid")
                                }
                                if (bric_y1 == "") {
                                    $('#bric_y1').addClass("is-invalid")
                                }
                                Swal.fire({
                                    title: 'Please fill out all required fields',
                                    confirmButtonText: 'Continue',
                    ...
                    jQuery.ajax({
                        ...
                        success: function(response) {
                            if (response['status'] == 1) {
                                Swal.fire({
                                    title: 'Success',
                                    text: formData['letting_status_name'] +
                                        " Successfully Added!",
                                    icon: 'success',
                                    showCancelButton: false,
                                    confirmButtonColor: '#3085d6',
                                    ...
                                    var options =
                                        '<option value="">Please Select</option><option value="0">Add new letting status</option>';
                                    $.each(response['data'], function(x, xVal) {
                                        options += '<option value="' + xVal['id'] +
                                            '">' + xVal['letting_status_name'] +
                                            '</option>';
                                    });
                                    $('#status').html(options);
                ...
                function autoEstimatedInterest() {
                    if ($("#agreed_purchase_price").val() != "" && $("#bridge_loan").val() != "" && $(
                            "#estimated_period").val() != "" && $("#loan_percentage").val() != "") {
                        var agreedPurchasePrice = formatWholeNumber($("input[name='agreed_purchase_price']").val());
                        var bridgeLoanPercentage = formatAsPercentage($("#bridge_loan").val(), 4);
                        var loanPercentage = formatAsPercentage($("#loan_percentage").val(), 4);
                        var estimatedInterest = (agreedPurchasePrice * loanPercentage) * bridgeLoanPercentage * $(
                            "#estimated_period").val();
                ...
                function autoEstimatedTPC() {
                    if ($("#agreed_purchase_price").val() != "" && $("#stamp_duty").val() != "" && $(
                            "#acquisition_cost").val() != "" && $("#agent_fee").val() != "" && $("#capex_budget")
                        .val() != "" && $("#estimated_interest").val() != "") {
                        var agreedPurchasePrice = formatWholeNumber($("input[name='agreed_purchase_price']").val());
                        ...
                        var estimatedTPC = parseInt(agreedPurchasePrice) + parseInt(stampDuty) + parseInt(
                            acquisitionCost) + parseInt(agentFee) + parseInt(capexBudget) + parseInt(
                            estimatedInterest);
                ...
                function autoBricPurchaseYield() {
                    if ($("#bric_y1_proposed_rent_pppw").val() != "" && $("#tenancy_length_weeks").val() != "" && $(
                            "#no_of_bric_beds").val() != "" && $("#estimated_tpc").val() != "") {
                        var bricY1 = formatWholeNumber($("#bric_y1_proposed_rent_pppw").val());
                        var estimatedTpc = formatWholeNumber($("#estimated_tpc").val());
                        var bricPurchaseYield = (bricY1 * $("#tenancy_length_weeks").val() * $("#no_of_bric_beds")
                            .val()) / estimatedTpc;
                ...
                function checkASCompleted() {
                    if ($("#acquisition_status").val() === "Completed" && $("#completion_date").datepicker('getDate') !=
                        null) {
