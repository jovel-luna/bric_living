      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview" style="display: none;">
            ...
            <li class="nav-item">
              <a href="{{ route('lettings.contract-list') }}" class="nav-link {{ (request()->is('lettings/contract-info')) ? 'active' : '' }}">
                <i class="nav-icon">
        ...
        <li class="nav-item">
          <a href="{{ route('get.advanced-search') }}" class="nav-link {{ (request()->is('settings/advancedSearch')) ? 'active' : '' }}">
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" style="fill:white" width="20" height="20" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
