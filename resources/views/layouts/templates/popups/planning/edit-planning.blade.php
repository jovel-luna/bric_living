<div class="modal fade" id="editPlanningModal" tabindex="-1" role="dialog" aria-labelledby="editPlanningModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="editPlanningForm">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="editPlanningModalLabel">Edit Planning</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="edit_date_submitted" type="text" class="form-control @error('date_submitted') is-invalid @enderror has-datepicker" name="date_submitted" value="{{ old('date_submitted') }}" placeholder="dd-mm-yyyy" autocomplete="date_submitted">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <!-- Approved -->
