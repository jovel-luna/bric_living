...
<script>
    $(document).ready(function() {
        ...
        function acquisition(property_phase = '', entity = '', city = '', area = '', no_bric_beds = '', status = '', postcode = '', address = '', showlimit = '', search = '', last_col_log = '') {
            $('#acquisitionTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'agreed_purchase_price',
                        name: 'agreed_purchase_price',
                        orderable: true
                    },
                    {
                        data: 'agent',
        ...
        $("form#side-popup-form-acqui").submit(function(e) {
            ...
            const acquisition_side_form_popup = document.getElementById('side-popup-form-acqui')
            const fData = new FormData(acquisition_side_form_popup);
            let formData = {};
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    if (response) {
                        ...
                        $('#side-tennure').val(response['data']['tennure']);
        ...
        function validateFields() {
            ...
            if (acquisition_status != "" && single_asset_portfolio != "" && existing_bedroom_no != "" && asking_price != "" && agent != "" && estimated_period != "" != "" && cdIsRequired == false) {
                ...
                if (acquisition_status == "") {
                    $('#side-acquisition_status').addClass("is-invalid")
                }
                if (single_asset_portfolio == "") {
                    $('#side-single_asset_portfolio').addClass("is-invalid")
                }
                if (existing_bedroom_no == "") {
                    $('#side-existing_bedroom_no').addClass("is-invalid")
                }
                if (asking_price == "") {
                    $('#side-asking_price').addClass("is-invalid")
                }
                if (agent == "") {
                    $('#side-agent').addClass("is-invalid")
                }
                if (estimated_period == "") {
                    $('#side-estimated_period').addClass("is-invalid")
                }
                if ($('#side-acquisition_status').val() != "") {
                    if ($('#side-acquisition_status').val() === "Completed") {
