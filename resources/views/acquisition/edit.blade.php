                ...
                <div class="card card-secondary shadow mb-4 p-0">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('property.update', $data) }}" autocomplete="off" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            <!-- <h6 class="mb-3">Property Info</h6> -->
                            <div class="card card-secondary shadow mb-4 p-0">
                                ...
                                <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                                ...
                                                                <select name="property_phase" id="property_phase" class="form-control form-control-alternative{{ $errors->has('property_phase') ? ' is-invalid' : '' }}">
                                                                    ...
                                                                    @if(old('property_phase'))
                                                                        @foreach($propertyPhase as $pPhase_key => $pPhase)
                                                                            <option value="{{ $pPhase_key }}" {{ $pPhase_key === old('property_phase') ? 'selected' : '' }}>{{ $pPhase }}</option>
                                                                        @endforeach
                                                                    @else
                                                                        @foreach($propertyPhase as $pPhase_key => $pPhase)
                                                                            <option value="{{ $pPhase_key }}" {{ $pPhase_key === $data->property_phase ? 'selected' : '' }}>{{ $pPhase }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <select name="entity" id="entity" class="form-control form-control-alternative{{ $errors->has('entity') ? ' is-invalid' : '' }}">
                                                                    <option value="">Please Select</option>
                                                                    @if(old('entity'))
                                                                        @foreach($entities as $entity_key => $entity_val)
                                                                            <option value="{{ $entity_val->id }}" {{ $entity_val->id === old('entity') ? 'selected' : '' }}>{{ $entity_val->entity }}</option>
                                                                        @endforeach
                                                                    @else
                                                                        @foreach($entities as $entity_key => $entity_val)
                                                                            <option value="{{ $entity_val->id }}" {{ $entity_val->id === $data->entity_id ? 'selected' : '' }}>{{ $entity_val->entity }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                                @error('entity')
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <input id="area" type="text" class="form-control @error('area') is-invalid @enderror" name="area" value="{{ old('area', $data->area) }}" required autocomplete="area" autofocus>
                                                                @error('area')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <input id="postcode" type="text" class="form-control @error('postcode') is-invalid @enderror" name="postcode" value="{{ old('postcode', $data->postcode) }}" autocomplete="postcode">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <input id="house_no" type="text" class="form-control @error('house_no') is-invalid @enderror" name="house_no" value="{{ old('house_no', $data->house_no_or_name) }}" autocomplete="house_no">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <input id="street" type="text" class="form-control @error('street') is-invalid @enderror" name="street" value="{{ old('street', $data->street) }}" autocomplete="street">
                                                        ...
                                                        <!-- No. of Bric Beds -->
                                                        <div class="mb-3">
                                                            <label for="no_bric_beds" class="col-form-label">{{ __('No. of Bric Beds') }}</label>
                        
                                                            <div class="">
                                                                <input id="no_bric_beds" type="number" min="1" max="99" placeholder="1-99" class="form-control @error('no_bric_beds') is-invalid @enderror" name="no_bric_beds" value="{{ old('no_bric_beds', $data->no_bric_beds) }}" autocomplete="no_bric_beds">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <input id="no_of_bric_bathroom" type="number" min="1" max="99" placeholder="1-99" class="form-control @error('no_of_bric_bathroom') is-invalid @enderror" name="no_of_bric_bathroom" value="{{ old('no_of_bric_bathroom', $data->no_bric_bathrooms) }}" autocomplete="no_of_bric_bathroom">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <select name="status" id="status" class="form-control form-control-alternative{{ $errors->has('status') ? ' is-invalid' : '' }}">
                                                                    ...
                                                                    @if(old('status'))
                                                                        @foreach($property_status as $property_status_key => $property_status_val)
                                                                            <option value="{{ $property_status_val->id }}" {{ $property_status_val->id == old('status') ? 'selected' : '' }}>{{ $property_status_val->letting_status_name }}</option>
                                                                        @endforeach
                                                                    @else
                                                                        @foreach($property_status as $property_status_key => $property_status_val)
                                                                            <option value="{{ $property_status_val->id }}" {{ $property_status_val->id == $data->status ? 'selected' : '' }}>{{ $property_status_val->letting_status_name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                                @error('status')
                                    ...
                                    <div class="row {{ $data->property_phase === 'In Development' || $data->property_phase === 'Bric Property' ? '' : 'd-none' }}" id="development-section">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="col-form-label document-label">{{ __('Development Info') }}</label>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <!-- Project Start Date -->
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                @error('projected_completion_date')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                                @enderror
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="">
                                                                <select name="development_status" id="development_status" class="form-control form-control-alternative{{ $errors->has('development_status') ? ' is-invalid' : '' }}">
                                                                    <option value="">Please Select</option>
                                                                    @if(old('development_status'))
                                                                        @foreach($development_status as $ds_key => $ds_val)
                                                                            <option value="{{ $ds_key }}" {{ $ds_val == old('development_status') ? 'selected' : '' }}>{{ $ds_val}}</option>
                                                                        @endforeach
                                                                    @else
                                                                        @foreach($development_status as $ds_key => $ds_val)
                                                                            <option value="{{ $ds_key }}" {{ $ds_val == $data->development_status ? 'selected' : '' }}>{{ $ds_val }}</option>
                                                                        @endforeach
                                                                    @endif
