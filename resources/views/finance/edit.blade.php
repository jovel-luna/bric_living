                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input id="cm_current_valuation" type="text" class="form-control @error('cm_current_valuation') is-invalid @enderror" name="cm_current_valuation" value="{{ old('cm_current_valuation', $data->cm_current_valuation) }}" autocomplete="cm_current_valuation">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <!-- Loan amount -->
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input id="cm_loan_amount" type="text" class="form-control @error('cm_loan_amount') is-invalid @enderror" name="cm_loan_amount" value="{{ old('cm_loan_amount', $data->cm_loan_amount) }}" autocomplete="cm_loan_amount">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input id="cm_loan" type="text" class="form-control @error('cm_loan') is-invalid @enderror" name="cm_loan" value="{{ old('cm_loan', $data->cm_loan) }}" autocomplete="cm_loan">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <!-- Interest rate -->
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input id="cm_interest_rate" type="text" class="form-control @error('cm_interest_rate') is-invalid @enderror" name="cm_interest_rate" value="{{ old('cm_interest_rate', $data->cm_interest_rate) }}" autocomplete="cm_interest_rate">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="mb-3 form-group">
                                                    ...
                                                    <input id="cm_monthly_repayments" type="text" class="form-control @error('cm_monthly_repayments') is-invalid @enderror" name="cm_monthly_repayments" value="{{ old('cm_monthly_repayments', $data->cm_monthly_repayments) }}" autocomplete="cm_monthly_repayments">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input id="m_account_no" type="text" class="form-control @error('m_account_no') is-invalid @enderror" name="m_account_no" value="{{ old('m_account_no', $data->m_account_no) }}" autocomplete="m_account_no">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input id="m_loan_period" type="text" class="form-control @error('m_loan_period') is-invalid @enderror" name="m_loan_period" value="{{ old('m_loan_period', $data->m_loan_period) }}" autocomplete="m_loan_period">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <!-- Estimated loan -->
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input id="m_estimated_loan" type="text" class="form-control @error('m_estimated_loan') is-invalid @enderror" name="m_estimated_loan" value="{{ old('m_estimated_loan', $data->m_estimated_loan) }}" autocomplete="m_estimated_loan">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <!-- Agreed loan -->
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input id="m_agreed_loan" type="text" class="form-control @error('m_agreed_loan') is-invalid @enderror" name="m_agreed_loan" value="{{ old('m_agreed_loan', $data->m_agreed_loan) }}" autocomplete="m_agreed_loan">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input id="m_estimated_equity_release" type="text" class="form-control @error('m_estimated_equity_release') is-invalid @enderror" name="m_estimated_equity_release" value="{{ old('m_estimated_equity_release', $data->m_estimated_equity_release) }}" autocomplete="m_estimated_equity_release">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input id="m_equity_release" type="text" class="form-control @error('m_equity_release') is-invalid @enderror" name="m_equity_release" value="{{ old('m_equity_release', $data->m_equity_release) }}" autocomplete="m_equity_release">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <!-- Loan % -->
                                                    <div class="mb-3 form-group">
                                                        ...
                                                        <input id="m_loan" type="text" class="form-control @error('m_loan') is-invalid @enderror" name="m_loan" value="{{ old('m_loan', $data->m_loan) }}" autocomplete="m_loan">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <!--  -->
