...
class OperationUtility extends Model implements Searchable
{
    use LogsActivity;
    use HasFactory;
    ...
    public function getSearchResult(): SearchResult
    {
        return new \Spatie\Searchable\SearchResult(
            ...
            $this->gas_provider ?? '',
            $this->gas_contract_start_date ?? '',
            $this->gas_contract_end_date ?? '',
            $this->gas_account_number ?? '',
            $this->electric_provider ?? '',
            $this->electric_contract_start_date ?? '',
            $this->electric_contract_end_date ?? '',
            $this->electric_account_number ?? '',
            $this->water_provider ?? '',
            $this->water_account_number ?? '',
            $this->tv_licence ?? '',
            $this->tv_licence_contract_start_date ?? '',
            $this->tv_licence_contract_end_date ?? '',
            $this->broadband_provider ?? '',
            $this->broadband_account_number ?? '',
