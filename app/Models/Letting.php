...
class Letting extends Model implements Searchable
{
    ...
    public function getSearchResult(): SearchResult
    {
        ...
        $property_contract_status = $this->property_contract_status ?? '';
        $target_weekly_rent = $this->target_weekly_rent ?? '';
        $achieved_weekly_rent = $this->achieved_weekly_rent ?? '';
        $floorplan = $this->floorplan ?? '';
        $date_of_refurb = $this->date_of_refurb ?? '';
        $tv = $this->tv ?? '';
